...
def main():
    top_genes = [
        'GBP1', 'HK1', 'GSN', 'ULK1', 'ERBB2', 'ERCC6', 'CPS1', 
        'SMARCA2', 'DDR2', 'ARPC4', 'TUBB2B', 'FHL5', 'CNPY3', 
        'CAMK1', 'ITPRIP', 'IGLV2-8', 'SKIC2', 'TMEM41B', 'SRPK2', 
        'KCTD17', 'DTNBP1', 'SRPRA', 'MAP4K2', 'TAF1', 'SPC25', 
        'NRBP2', 'NOL9', 'ATIC', 'DNAL1', 'RAB23'
    ]
